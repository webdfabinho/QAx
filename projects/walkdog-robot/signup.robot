...
Deve poder cadastrar um novo dog walker
    ...
    ${name}              Set Variable    Fabio Neri
    ${email}             Set Variable    webdfabinho@gmail.com
    ...
    ${addressNumber}     Set Variable    119
    ${addressDetails}    Set Variable    C3
    ...
    Submit signup form
    Popup shold be    Recebemos o seu cadastro e em breve retornaremos o contato.
